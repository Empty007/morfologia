//calcula todas as solucões tais que o feasible C está no upper bound, e so testar o upper bound substração pelo C, e que esteja contido no lower bound
# include <stdio.h>
...
//			printf("ENTRO\n");
			testa_equacao(&solucao, &base_Y, &str, &upper);
