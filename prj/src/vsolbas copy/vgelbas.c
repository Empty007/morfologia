...
/*=*/ int testa_equacao_dilatacao_crescente (trv_struc * base, mat_str * str, 
	...
	trv_struc diferenca, desmonta, base_X, base_Y;
...
//		disp_basis_by_ron (&upper);
		...
		gera_lower_bounds_crescente_by_edu (&lower, base, &str, &upper);
		testa_equacao_dilatacao_crescente (base, &str, lower, &solucao, &upper);
